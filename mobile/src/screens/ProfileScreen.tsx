...
export function ProfileScreen() {
  ...
  return (
    <ScreenContainer>
      ...
      <Button title="Consultas" variant="secondary" onPress={() => navigation.navigate('Appointments')} />
      ...
      <Button title="Privacidade e dados" variant="secondary" onPress={() => navigation.navigate('Privacy')} />
